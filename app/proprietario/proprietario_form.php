...
$htmlForm .= $form->addInput('text', 'pro_var_email', 'E-mail*', array('maxlength' => '50', 'validate' => 'required'));
$htmlForm .= $form->addInput('text', 'pro_var_telefone', 'Telefone*', array('maxlength' => '100', 'validate' => 'required'));
